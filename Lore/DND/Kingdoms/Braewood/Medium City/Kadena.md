...
**Terrain:**
- River valley with engineered terraces supporting the city.
- The bridge approaches are heavily fortified on both ends.
- Surrounding farmland provides food, but the city's wealth comes from trade.

**Climate:**
- Warm and humid, influenced by the nearby lake and river.
- River mists are common in morning hours.
- Mild winters; the river rarely freezes.
...
- Fortified gatehouses at both ends can seal the bridge within minutes.
- The garrison trains constantly with their counterparts in Rye.
- Despite excellent relations between the kingdoms, the bridge remains heavily militarized—everyone remembers what happened when the Tharnic Empire controlled both ends.
...
- Residents are prosperous but live under constant security scrutiny.
- The checkpoint process can be frustrating for locals who cross regularly.
- Strong sense of pride in the bridge and its history.
- Diverse population creates a cosmopolitan atmosphere, but also occasional tensions.
- Many residents feel caught between two kingdoms, fully belonging to neither.
...
**Primary Industries:**
- **Bridge Tolls:** The foundation of all wealth. Every crossing pays.
- **Hospitality:** Inns and taverns serve travelers waiting to cross.
- **Banking:** Currency exchange and trade financing.
- **Wagon Services:** Secure storage for weapons during crossing; wagon inspection and repair.
...
- The Bridge-Warden position was created to ensure neither kingdom dominated.
- Kadena and Rye developed in parallel, becoming mirror cities.
...
|------|------|------|-------|
| **Elara Thornguard** | Bridge-Warden | Human | Commands the city; answers to two crowns |
| **Captain Drem Holt** | Commander, Span Wardens | Human | Elite bridge guard commander |
| **Guildmaster Loren Fairweather** | Head of the Merchant Consortium | Half-Elf | Coordinates trade between kingdoms |
| **High Banker Yorin Crestmont** | Master of the Exchange | Human | Controls the banking quarter |
| **Father Selwyn Oathkeeper** | Chaplain, Shrine Row | Human | Maintains interfaith harmony on the bridge |
...
- **Braewood Crown:** Kadena is loyal but independent-minded. The Crown cannot dictate to the Bridge-Warden.
- **Islefield Crown:** Same relationship—respect without subservience.
...
1. **Eastern Approach (Braewood):** Gatehouse, inspection yards, weapons storage.
2. **Eastern Tavern Quarter:** First taverns and inns for westbound travelers.
...
**Security Protocol:**
- All weapons surrendered at point of entry.
- Wagons inspected for contraband.
- Papers verified; suspicious travelers questioned.
- Weapons returned at exit—a sophisticated claim system ensures accuracy.
- Span Wardens patrol constantly; both kingdoms contribute equal numbers.

**Historical Significance:**
- The bridge enabled the Tharnic Empire's continental dominance.
- Its construction is considered miraculous—modern engineers cannot fully explain how it was built.
- Control of the bridge has determined the outcome of multiple wars.
- The current peace exists partly because neither kingdom wants the other to control both ends.
